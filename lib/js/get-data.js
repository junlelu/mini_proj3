...
function displayAnnotation(annotation) {
  ...
  email_note.innerHTML = "test" + annotation;
}
...
//function to display the observation values you will need to update this
function displayEmail(obs) {
  email_height.innerHTML = "Height:" + obs.height;
  email_weight.innerHTML = "Weight:" + obs.weight;
}
...
FHIR.oauth2.ready().then(function(client) {
  ...
  client.request("Observation?" + query, {
    ...
    //Most medication request code is referenced from this: http://docs.smarthealthit.org/client-js/request.html
...
function addWeightAnnotation(e) {
